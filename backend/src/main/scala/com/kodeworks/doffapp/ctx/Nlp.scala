...
trait NlpImpl extends Nlp {
  this: MostUsedWords =>
  println("Loading Nlp")
  override val liblinearConfig = LiblinearConfig(cost = 5d, eps = .1, solverType = SolverType.L1R_LR)
  //, showDebug = true)
  ...
  override val tfidfBatchFeaturizer = new TfidfBatchFeaturizer[String](0, Set(), true)
  //, mostUsedWordsTop64) //TODO check if add defualt makes any difference
  override val bowFeaturizer = new BowTfIdfFeaturizer()
  //mostUsedWordsTop64)
