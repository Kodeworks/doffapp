...
class BrainTest {
  ...
  val t1 = Tender(
    ...
    "asdf",
    "giff",
    Instant.parse("2014-11-25T00:00:00Z").toEpochMilli,
    Some(Instant.parse("2017-01-15T00:00:00Z").toEpochMilli),
    Some("Trondheim"),
    Some("S\u00f8r-Tr\u00f8ndelag"),
    Some("hepp"))
  val t2 = Tender(
    ...
    "gremlin",
    "gegg",
    Instant.parse("2005-11-25T00:00:00Z").toEpochMilli,
    Some(Instant.parse("2006-01-15T00:00:00Z").toEpochMilli),
    Some("Trondheim"),
    Some("S\u00f8r-Tr\u00f8ndelag"),
    Some("nibb"))
  val t3 = Tender(
    ...
    "gnagg",
    "hubba",
    Instant.parse("2012-11-25T00:00:00Z").toEpochMilli,
    Some(Instant.parse("2011-01-15T00:00:00Z").toEpochMilli),
    Some("Oslo"),
    Some("Oslo"),
    Some("gakka"))
